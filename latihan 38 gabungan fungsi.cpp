...
{
    system("cls");
    gotoxy (35,5); cout << "MASUKKAN DATA PEGAWAI";
    gotoxy (35,6); cout << "=================================================";
...
void baca()
{
	...
	while((fread(&pgw[n],sizeof(pgw[n]),1,coba))==1 )
	{
		i++;
		gotoxy(5,4+i); cout << i;
		gotoxy(14,4+i); cout << pgw[n].nik;
		gotoxy(30,4+i); cout << pgw[n].nama;
